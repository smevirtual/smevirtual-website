...
const GIT_HOOKS_MODE =
  fs.constants.S_IRUSR | fs.constants.S_IWUSR | fs.constants.S_IXUSR | fs.constants.S_IRGRP | fs.constants.S_IROTH;
...
mainStory.info("Hang on while we set up the project on your system and do some checks...");
